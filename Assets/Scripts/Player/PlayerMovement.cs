...
public class PlayerMovement : MonoBehaviour
{
   ...
   [ SerializeField ]
    ...
    public GameObject bushDestroyer;
    ...
    void Update()
    {
        ...
        if(!bushes[0].activeInHierarchy && !bushes[1].activeInHierarchy && !bushes[2].activeInHierarchy && !bushes[3].activeInHierarchy && !bushes[4].activeInHierarchy && !bushes[5].activeInHierarchy)
        {
